...
auth_url = (
    ...
    f"refresh_token=code&" # Corrigido de response_type para consistência
...
if atleta_id_selecionado:
    ...
    if not df_treinos.empty:
        # AQUI ESTAVA O ERRO DE INDENTAÇÃO - Tudo abaixo deve estar alinhado
        ...
        st.info("Nenhum dado encontrado para este atleta nas colunas selecionadas.")
else:
